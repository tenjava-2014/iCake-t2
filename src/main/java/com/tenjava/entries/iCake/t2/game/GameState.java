...
public enum GameState {
    ...
    WAITING(20, "&eGame starting in &6%s", "&6Game starting, good luck!", new WaitingAction()), // 60
    INVINCIBLE(20, "&cInvincibility is over in &4%s", "&4Invincibility has worn off!", new InvincibleAction()), // 30
    STARTED(60, "&eGame ending in &6%s", "&6Game ending!", new StartingAction()), // 600
    ENDING(20, "&eSwitching worlds in &6%s", "&6Switching worlds...", new EndingAction()); // 30
